(function () {
    ...
    app.directive('pbImageWidget', ['$compile', function ($compile) {
        // Opens and clsoes the sidebar menu.
        // Usage:
        // <div data-pb-drag-components>
        var directive = {
        ...
        function controller($scope, $element) {
            ...
            $scope.updateProperty = function () {
                ...
                if (typeof $scope.property.targetElement === 'undefined') {
					...
					alert($scope.property.targetElement);
					alert($scope.$parent.component.id);
                    var $activeComponent = $('[data-component-ref="' + $scope.$parent.component.id + '"]').find($scope.property.targetElement);
                }
                ...
                if ($scope.property.html_attr === 'class') {
					...
					alert(JSON.stringify($activeComponent));
					alert($scope.property.html_attr + " --- " + $scope.property.val)
                    $activeComponent.attr($scope.property.html_attr, $scope.property.val);
                    $scope.imageUrl = $scope.property.val;
                }
...
alert($scope.property.val);
	...
	app.directive('pbGridWidget', ['$compile', function ($compile) {
        // Opens and clsoes the sidebar menu.
        // Usage:
