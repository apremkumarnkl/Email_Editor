(function () {
    ...
    function components() {
        ...
        add("bs-img", { name: 'Image', id: 'c-img', disableHoverOn: ['img'], html: '<div class="form-group"><img src="http://localhost:81/Email_Editor/Sample/Desert.jpg" width="100%" height="100%"></div>',
			properties: [{
                name: "Image",
                key: "src",
                html_attr: "src",
                targetElement: 'img',
                val: 'http://localhost:81/Email_Editor/Sample/Desert.jpg',
                widgettype: 'image'
            },
			{
                name: "Width",
        ...
        add("bs-grid-row", { name: 'Grid', id: 'c-grid-row', isDroppable: true, droppables: ['.row-col'], disableHoverOn: ['.row-col', '.placeholder'], html: '<div class="row"><div class="col-md-6 row-col"></div><div class="col-md-6 row-col"></div></div>',
            properties: [{
                name: "Grid",
                key: "grid",
                html_attr: "node",
